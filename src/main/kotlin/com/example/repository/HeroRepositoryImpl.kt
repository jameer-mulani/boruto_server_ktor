...
class HeroRepositoryImpl : HeroRepository {
    ...
    override suspend fun getAllHeroes(page: Int): ApiResponse {
        ...
        val pageCalculation = calculatePage(page)

        return ApiResponse(
            success = true,
            message = "Ok",
            prevPage = pageCalculation[PREVIOUS_PAGE_KEY],
            nextPage = pageCalculation[NEXT_PAGE_KEY],
            heroes = heroes[page]!!
        )
    }
    ...
    override suspend fun searchHero(title: String): ApiResponse {

        return ApiResponse(
            success = true,
            message = "Ok",
            heroes = findHeroes(title)
        )
